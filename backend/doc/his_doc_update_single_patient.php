...
<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['update_patient']))
		{
			...
			$query="UPDATE  his_patients  SET pat_fname=?, pat_lname=?, pat_age=?, pat_dob=?,  pat_phone=?, pat_type=?, pat_addr=?, pat_condition=?, pat_dept=?,pat_treatment=?,ref_unit=? WHERE pat_number=?";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('sssssssss', $pat_fname, $pat_lname, $pat_age, $pat_dob,  $pat_phone, $pat_type, $pat_addr, $pat_condition, $pat_number,$pat_dept,$pat_treatment,$ref_unit);
			$stmt->execute();
			/*
